...
3. The build step installs requirements, installs Node dependencies with `npm ci`, compiles Tailwind CSS with `npx tailwindcss -i input.css -o static/styles.css --minify`, and runs `python freeze.py`.
